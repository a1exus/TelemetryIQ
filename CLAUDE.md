...
**Phase 6** (complete): Lap data export — CSV per lap.
**Phase 7** (complete): GT7-aligned compare view — three tabs (Driving Line / Inputs / Powertrain), engine RPM trace, hash-persisted tab.
